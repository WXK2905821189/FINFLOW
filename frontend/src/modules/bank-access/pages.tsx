...
import { Alert, Card, Empty, Skeleton, Table, type TableColumnsType } from 'antd';
import { bankApi, operationsApi } from '../../services/api';
import { useRemote, ResourceFailure, StatusTag, DirectStatusTag, PhaseOneNotice } from '../shared/components';
