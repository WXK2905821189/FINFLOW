...
function SyncScheduleCard() {
  ...
  return (
    <Card
      ...
      extra={nextFire && <span className="muted-inline">下次触发时刻：{nextFire.format('MM-DD HH:mm')}</span>}
    >
